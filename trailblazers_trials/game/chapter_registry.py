CHAPTERS = [
    ...
    },
    {
        ...
        "number": "Chapter 2",
        "roman": "Chapter II",
        "title": "Oren Gets Ready",
        "location": "Highguard Inn",
        "summary": "Wake Oren, armor him, and send him into the corridor for the next mission placeholder.",
        "tagline": "The next mission begins before the door opens.",
        "menu_background": "cg chapter_02_oren_hallway",
        ...
        "checkpoints": [
            {
                "label": "chapter_02",
                "menu_label": "Opening",
                "description": "Begin the Chapter 2 placeholder as Oren wakes in his room.",
            },
            {
                "label": "chapter_02_checkpoint_evening",
                "menu_label": "Armoring",
                "description": "Skip to Oren fastening his armor.",
            },
            {
                "label": "chapter_02_checkpoint_mine",
                "menu_label": "Hallway Exit",
                "description": "Jump to Oren stepping into the inn corridor.",
            },
        ],
    },
]
